...
<div style="background:url('/assets/images/title_img.png'); ">
    <div class="container">
        <div class="row items-center justify-between py-20">
            ...
            <div class="col-3">
                <p class="offset-1 text-sm"> Instructors > Astrit Demiri </p>
            </div>
        </div>
    </div>
</div>
<div class="container mt-40">
    <div class="row items-center">
        <div class="lg:col-2">
            <img src="/assets/images/instructor2.jpg">

        </div>
        <div class="lg:col-2">
            <h2 class="font-semibold text-2xl text-orange-500"> Astrit Demiri </h2>
        </div>
    </div>
    <div class="row">
        <div class="lg:col-4">
